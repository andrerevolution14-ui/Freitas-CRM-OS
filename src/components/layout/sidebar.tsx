...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* User footer & Backlink */}
      <div className="px-2.5 py-3" style={{ borderTop: '1px solid rgba(255,255,255,0.055)' }}>
        <a
          href="https://grupofreitasrenovacoes.pt"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-between px-3 py-1.5 mb-2 rounded-[4px] text-[11px] font-semibold text-slate-400 hover:text-blue-400 hover:bg-white/[0.04] transition-colors group"
          title="Grupo Freitas Renovações — Website Oficial"
        >
